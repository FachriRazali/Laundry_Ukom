...
<div class="container futuristic-container">
    <div class="header">
        <h1 class="title"><i class="fas fa-plus-circle"></i> Add New Outlet</h1>
        <div class="actions">
        ...
        <div class="card-body">
            <form action="{{ route('outlets.store') }}" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="name" class="form-control futuristic-input" placeholder="Enter outlet name" required>
                </div>

                <!-- 🌟 Address -->
                <div class="mb-3">
                    <label class="form-label"><i class="fas fa-map-marker-alt"></i> <strong>Address</strong></label>
                    <textarea name="address" class="form-control futuristic-input" rows="3" placeholder="Enter outlet address" required></textarea>
                </div>

                <!-- 🌟 Action Buttons -->
                <div class="form-actions">
                    <button type="submit" class="btn-save"><i class="fas fa-save"></i> Create Outlet</button>
