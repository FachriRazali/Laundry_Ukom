...
<div class="container futuristic-container">
    <div class="header">
        ...
        <div class="actions">
            <a href="{{ route('kasir.customers.index') }}" class="btn-glass shadow-neon">
    ...
    <div class="card futuristic-card">
        <div class="card-body">
            <form action="{{ route('kasir.customers.update', $customer->id) }}" method="POST">
                ...
                <a href="{{ route('kasir.customers.index') }}" class="btn-glass btn-neon-red"><i class="fas fa-times"></i> Cancel</a>
            </form>
        </div>
    </div>
</div>
