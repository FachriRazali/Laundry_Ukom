...
<div class="container futuristic-container">
    <div class="header">
        <h1 class="title"><i class="fas fa-user-edit"></i> Edit User</h1>
        ...
        <div class="card-body">
            <form action="{{ route('users.update', $user->id) }}" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="name" class="form-control futuristic-input" value="{{ $user->name }}" required>
                </div>

                <div class="mb-3">
                    <label class="form-label"><strong><i class="fas fa-envelope"></i> Email</strong></label>
                    <input type="email" name="email" class="form-control futuristic-input" value="{{ $user->email }}" required>
                </div>
                ...
                <button type="submit" class="btn-glass btn-neon-green"><i class="fas fa-save"></i> Save Changes</button>
