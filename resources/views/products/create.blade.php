...
<div class="container futuristic-container">
    <div class="header">
        <h1 class="title"><i class="fas fa-plus"></i> Add New Product</h1>
        ...
        <div class="card-body">
            <form action="{{ route('products.store') }}" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="name" class="form-control futuristic-input" placeholder="Enter product name" required>
                </div>
                ...
                <div class="mb-3">
                    ...
                    <div class="input-group">
                        ...
                        <input type="number" name="price" class="form-control futuristic-input" placeholder="Enter product price" required>
                    </div>
                </div>
