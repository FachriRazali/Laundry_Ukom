...
<div class="container futuristic-container">
    <div class="header">
        ...
        <div class="actions">
            ...
            <a href="{{ route('kasir.customers.create') }}" class="btn-glass btn-neon-green">
                        ...
                        @foreach ($customers as $customer)
                            <tr>
                                ...
                                <td class="text-center">
                                    <a href="{{ route('kasir.customers.edit', $customer->id) }}" class="btn btn-warning btn-sm">
                                        <i class="fas fa-edit"></i> Edit
                                    </a>
                                    <form action="{{ route('kasir.customers.destroy', $customer->id) }}" method="POST" class="d-inline" onsubmit="return confirm('Are you sure you want to delete this customer?');">
                                        @csrf @method('DELETE')
